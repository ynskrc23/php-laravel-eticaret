...
class HomeController extends Controller
{
    ...
    public function index(){
    	...
    	$all_product_show=DB::table('tbl_products')
        ...
        ->where('tbl_products.publication_status',1)
     	...
     	$manage_product_show=view('pages.home_content')
     	->with('all_product_show',$all_product_show);
     	return view('layout')
     	->with('pages.home_content',$manage_product_show);
    }
    ...
    public function show_product_by_manufacture($manufacture_id){
        ...
        ->join('tbl_manufacture','tbl_products.manufacture_id','=',
