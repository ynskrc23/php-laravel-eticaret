                            ...
                            $all=DB::table('tbl_category')
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a href="{{URL::to('/product_by_category/'.$c->category_id)}}">{{$c->category_name}}</a>
                                    </h4>
                                </div>
                            <?php } ?>                               
                            </div>
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                ...
                                $all=DB::table('tbl_manufacture')
                                    ...
                                    ->get();
                                foreach ($all as $m) {?>
                                    <li><a href="{{URL::to('/product_by_manufacture/'.$m->manufacture_id)}}">{{$m->manufacture_name}}</a></li>
                                <?php } ?>      
                                </ul>
