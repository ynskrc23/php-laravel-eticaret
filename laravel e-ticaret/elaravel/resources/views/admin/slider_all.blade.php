  ...
  <!--PAGE CONTENT -->
        <div id="content">  
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="row">
                    <div class="col-lg-12">                                  
                        <a class="btn btn-success" href="/slider-add">Add</a>
                    </div>
                </div>
                  <!--END BLOCK SECTION -->
                <hr />
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                   ...
                                   @foreach($slider_all as $sl)
                                    <tbody>
                                        <tr class="odd gradeX">
                                            <td> <img src="{{\Illuminate\Support\Facades\Storage::url($sl->slider_image)}}" style="height: 120px" width="360px;"> </td>
                                            
                                            <td class="center">
                                                @if($sl->publication_status==1)
                                            ...
                                            <td class="center"> 
                                                    <a href="/edit-slider/{{$sl->slider_id}}" class="btn btn-info btn-sm"> Update  </a>
                                                    <a href="/delete-slider/{{$sl->slider_id}}" class="btn btn-danger"> Delete </a>        
                                            </td> 
                                        </tr>                                    
                                    </tbody>
                                    @endforeach
