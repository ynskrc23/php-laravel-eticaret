  ...
  <!--PAGE CONTENT -->
        <div id="content">  
            <div class="inner" style="min-height: 700px;">
                ...
                <div class="row">
                    <div class="col-lg-12">                                  
                        <a class="btn btn-success" href="/category-add">Add</a>
                    </div>
                </div>
                  <!--END BLOCK SECTION -->
                <hr />
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">                                        
                                                <a href="{{URL::to('/edit-category/'.$c->category_id)}}" class="btn btn-info btn-sm"> Update  </a>

                                                <a href="{{URL::to('/delete-category/'.$c->category_id)}}" class="btn btn-danger btn-sm"> Delete  </a>
                                            </td> 
                                        </tr>                                    
                                    </tbody>
                                    @endforeach
