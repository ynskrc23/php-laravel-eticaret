	            	...
	            	<form action="{{ url('/save-manufacture') }}" method="POST">
	            		 {{ csrf_field() }}
					  	<div class="form-group">
					    	...
					    	<input type="text" class="form-control" name="manufacture_name" placeholder="Manufacture Name">				    
					    </div>

					    <div class="form-group">
						    <label>Manufacture Description</label>
						    <textarea class="form-control" name="manufacture_description" rows="7"></textarea>
