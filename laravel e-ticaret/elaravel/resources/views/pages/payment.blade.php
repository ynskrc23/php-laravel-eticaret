...
<div class="form-group">
<label for="cardExpiry"><span class="hidden-xs">EXPIRATION</span><span class="visible-xs-inline"></span> </label>
<input 
type="tel" 
class="form-control" 
name="cardExpiry"
...
<div class="row">
<div class="col-xs-12">
<button class="btn btn-success pull-left" type="submit">Start Subscription</button>
</div>
</div>
