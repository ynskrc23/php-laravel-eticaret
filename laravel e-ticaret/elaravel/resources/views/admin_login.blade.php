...
<link rel="stylesheet" href="{{('backend/assets/plugins/magic/magic.css')}}" />
...
<div class="tab-content">
  ...
  <div id="login" class="tab-pane active">
      <form action="{{url('/admin-dashboard')}}" method="POST" class="form-signin">
          {{ csrf_field() }}
          <p class="text-muted text-center btn-block btn btn-primary btn-rect">
              Enter your username and password
          </p>
          <input type="text" name="admin_email" placeholder="Username" class="form-control" />
